...
public class CollectionUtils {
    ...
    public static <T> Optional<T> getFirst(Collection<T> list, Predicate<T> condition) {
        for (T element : list) {
            if (condition.test(element)) return Optional.ofNullable(element);
        }
        return Optional.empty();
    ...
    public static <T, K extends Comparable<K>> T findMax(Collection<T> collection, Function<T, K> valueFunction) {
        T largestElement = null;
        K largestValue = null;

        for (T element : collection) {
            K value = valueFunction.apply(element);
    ...
    public static <T, K extends Comparable<K>> T findMin(Collection<T> collection, Function<T, K> valueFunction) {
        T smallestElement = null;
        K smallestValue = null;
